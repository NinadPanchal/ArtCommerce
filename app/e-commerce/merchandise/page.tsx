...
export default function MerchandisePage() {
    ...
    const products = (productsData as Product[]).filter(p => p.type === 'merchandise')

    const categories = [
        { value: 'all', label: 'All Merchandise' },
        { value: 'apparel', label: 'T-Shirts & Apparel' },
        { value: 'bags', label: 'Tote Bags' },
        { value: 'drinkware', label: 'Mugs & Drinkware' },
            ...
            <div className="bg-white border-b border-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <p className="text-lg text-text-muted max-w-2xl">
                        Discover unique merchandise featuring original artwork from our talented artists.
                        From t-shirts to home décor, wear and use art every day.
                    </p>
                </div>
            </div>
